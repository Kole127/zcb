<?php
/**
 * Title: ZCB Naslovnica
 * Slug: zeleni-centar-bjelovar/zcb-naslovnica
 * Categories: featured
 * Inserter: true
 */
?>
			...
			<div id="kontakt">
				...
				<div class="zcb-contact-box">
					<form class="zcb-contact-form">
						...
						<div class="zcb-contact-field">
							<input class="zcb-contact-input" type="email" placeholder="E-mail adresa *">
						</div>
						<div class="zcb-contact-field zcb-contact-field--full">
							<textarea class="zcb-contact-textarea" placeholder="Poruka / upit *"></textarea>
						</div>
						<div class="zcb-contact-field zcb-contact-field--full">
